...
class PenjumlahanBlocMode2Level1
  ...
  void _onRestartGame(
      PenjumlahanMode2Level1ResetEvent event, Emitter<PenjumlahanState> emit) {
    _timer.cancel();
    _remainingTime = _timeLimit;
    add(PenjumlahanMode2Level1StartTimer());

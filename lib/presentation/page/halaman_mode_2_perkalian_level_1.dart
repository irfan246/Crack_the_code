...
class HalamanMode2PerkalianLevel1 extends StatelessWidget {
  const HalamanMode2PerkalianLevel1({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<PerkalianBlocMode2Level1, PerkalianState>(
      ...
      builder: (context, state) {
        if (state is PerkalianLoadedState) {
          ...
          return Scaffold(
            appBar: const WidgetAppbar(title: 'MODE 2 - LEVEL 1'),
            body: Stack(
              children: [
                Positioned(
                  top: 10,
                      ...
                      children: List.generate(4, (index) {
                        ...
                        return WidgetBrangkas(
                          ...
                          onButtonTap: (selectedNumber) {
                            context.read<PerkalianBlocMode2Level1>().add(
                                  SelectNumber(
                                    safeIndex: index,

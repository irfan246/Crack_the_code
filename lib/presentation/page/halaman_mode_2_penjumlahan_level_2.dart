...
class HalamanMode2PenjumlahanLevel2 extends StatelessWidget {
  const HalamanMode2PenjumlahanLevel2({super.key});

  @override
  Widget build(BuildContext context) {
    final screenWidth = MediaQuery.of(context).size.width;
    final screenHeight = MediaQuery.of(context).size.height;
    return BlocConsumer<PenjumlahanBlocMode2Level2, PenjumlahanState>(
                      ...
                      children: List.generate(4, (index) {
                        ...
                        return WidgetBrangkas(
                          ...
                          onButtonTap: (selectedNumber) {
                            context.read<PenjumlahanBlocMode2Level2>().add(
                                  SelectNumber(
                                    safeIndex: index,

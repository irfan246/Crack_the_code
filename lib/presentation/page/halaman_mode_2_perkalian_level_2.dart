...
class HalamanMode2PerkalianLevel2 extends StatelessWidget {
  const HalamanMode2PerkalianLevel2({super.key});

  @override
  Widget build(BuildContext context) {
    final screenWidth = MediaQuery.of(context).size.width;
    final screenHeight = MediaQuery.of(context).size.height;
    return BlocConsumer<PerkalianBlocMode2Level2, PerkalianState>(
                      ...
                      children: List.generate(4, (index) {
                        ...
                        return WidgetBrangkas(
                          ...
                          onButtonTap: (selectedNumber) {
                            context.read<PerkalianBlocMode2Level2>().add(
                                  SelectNumber(
                                    safeIndex: index,
